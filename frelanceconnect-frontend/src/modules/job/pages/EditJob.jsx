...
import { getJobById, updateJob } from "../../../core/services/job.service";
...
const EditJob = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("UPDATE JOB ERROR:", err.response?.data || err.message);
  ...
  if (fetching) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50 flex items-center justify-center">
        <div className="text-slate-500 text-lg font-semibold animate-pulse">
          Loading job...
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50 p-8">
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        >
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-slate-500">
                Update the details below to edit your job post.
              </p>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-7">
            ...
            <div>
              ...
              <motion.div
                whileHover={{ y: -1 }}
                className={fieldClass("title", "border-indigo-500 shadow-indigo-100")}
              >
                <input
                  type="text"
                  name="title"
            ...
            <div>
              ...
              <motion.div
                whileHover={{ y: -1 }}
                className={`
                  rounded-3xl border p-5 bg-slate-50
            ...
            <div>
              ...
              <motion.div
                whileHover={{ y: -1 }}
                className={fieldClass("budget", "border-green-500 shadow-green-100")}
              >
        ...
        <motion.div
          ...
          className="
            bg-white border border-slate-200
            rounded-[32px] p-7 shadow-sm h-fit
          "
        >
